...
struct Ray {
  ...
  double wavelength;  ///< wavelength of the ray in nanometers (nm)
   ...
   * \param wavelength wavelength of the ray in nanometers
   */
    Ray(const Vector3D o, const Vector3D d, int depth = 0, double wavelength = 550.0)
   ...
   * \param wavelength wavelength of the ray in nanometers
   */
    Ray(const Vector3D o, const Vector3D d, double max_t, int depth = 0, double wavelength = 550.0)
